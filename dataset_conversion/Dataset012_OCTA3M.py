...
if __name__ == '__main__':  
    # 数据集配置  
    dataset_id = 12  
    dataset_name = f'Dataset{dataset_id:03d}_OCTA3M'  
      
    # 源路径  
    oct_source = '/work/imc_lab/ys_z/Snake-SWin-OCTA/datasets/OCTA-500/3M/ProjectionMaps/OCT(ILM_OPL)'  
    octa_source = '/work/imc_lab/ys_z/Snake-SWin-OCTA/datasets/OCTA-500/3M/ProjectionMaps/OCTA(ILM_OPL)'  
    gt_source = '/work/imc_lab/ys_z/Snake-SWin-OCTA/datasets/OCTA-500/3M/GT_LargeVessel'  
    ...
    process_labels(gt_source, labelsTs, start_idx + train_count, end_idx,  
                  'OCTA3M', counter + train_count, '.bmp')
